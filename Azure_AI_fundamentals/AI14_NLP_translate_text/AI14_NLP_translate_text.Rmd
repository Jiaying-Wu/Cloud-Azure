...
Create a Codespace with the following settings (if you don't already have a Visual Studio Codespaces billing plan, you'll be prompted to create one):
Codespace Name: A name for your codespace - for example, ai-fundamentals.
Git Repository: MicrosoftDocs/ai-fundamentals
Instance Type: Standard (Linux) 4 cores, 8GB RAM
Suspend idle Codespace after: 30 minutes
Wait for the codespace to be created. This will take around 3 minutes, during which time:
...
Exercise notebook
After you have set up the Visual Studio environment, open the Translation.ipynb notebook to complete the exercise.
...
rmarkdown::render(input = "AI14_NLP_translate_text.Rmd", output_format = "github_document", output_file = "README.md")
```
