...
#### 3.2 Services ![](https://docs.microsoft.com/en-gb/learn/modules/predict-costs-and-optimize-spending/media/2b-billing-period-graphic.png){width=8% heigth=8%}
...
#### 3.4 Azure billing zones ![](https://docs.microsoft.com/en-gb/learn/modules/predict-costs-and-optimize-spending/media/1b-azure-regions-globe.png){width=8% heigth=8%}
...
rmarkdown::render(input = "F12_azure_cost.Rmd", output_format = "github_document", output_file = "README.md")
```
