...
##### 2.2.1 Data ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/2-data.png){width=8% heigth=8%}
...
##### 2.2.2 Application ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/2-application.png){width=8% heigth=8%}
...
##### 2.2.3 Compute ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/2-compute.png){width=8% heigth=8%}
...
##### 2.2.4 Networking ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/2-networking.png){width=8% heigth=8%}
...
##### 2.2.5 Perimeter ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/2-perimeter.png){width=8% heigth=8%}
...
##### 2.2.6 Identity and access ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/2-policies-and-access.png){width=8% heigth=8%}
...
##### 2.2.7 Physical security ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/2-physical-security.png){width=8% heigth=8%}
...
##### 4.3.1 SSO with Azure Active Directory ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/3-sso-with-azure-ad.png){width=8% heigth=8%}
...
##### 4.5.1 Service principals ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/3-service-principals.png){width=8% heigth=8%}
...
##### 4.5.2 Managed identities for Azure services ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/3-managed-service-identities.png){width=8% heigth=8%}
...
##### 5.4.1 Encrypt raw storage ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/4-encrypt-raw-storage.png){width=8% heigth=8%}
...
##### 5.4.2 Encrypt virtual machine disks ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/4-encrypt-virtual-machines.png){width=8% heigth=8%}
...
##### 5.4.3 Encrypt databases ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/4-encrypt-databases.png){width=8% heigth=8%}
...
##### 5.4.4 Encrypt secrets ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/4-encrypt-secrets.png){width=8% heigth=8%}
...
##### 7.1.1 Internet protection ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/5-internet-protection.png){width=8% heigth=8%}
...
##### 7.2.1 Virtual network security ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/5-vnet-security.png){width=8% heigth=8%}
...
##### 7.2.2 Network integration ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-security-in-azure/media/5-network-integration.png){width=8% heigth=8%}
...
rmarkdown::render(input = "F09_azure_security.Rmd", output_format = "github_document", output_file = "README.md")
```
