...
5. Select **+ Add**. The **Create a virtual machine** pane appears.
...
#### 5.2 Azure Cloud Shell ![](https://docs.microsoft.com/en-gb/learn/modules/tour-azure-portal/media/5-cloud-shell-icon.png){width=5% heigth=5%}
...
#### 5.3 Directory and subscription ![](https://docs.microsoft.com/en-gb/learn/modules/tour-azure-portal/media/5-subscription-icon.png){width=5% heigth=5%}
...
#### 5.5 Settings ![](https://docs.microsoft.com/en-gb/learn/modules/tour-azure-portal/media/5-settings-icon.png){width=5% heigth=5%}
...
#### 5.6 Help pane ![](https://docs.microsoft.com/en-gb/learn/modules/tour-azure-portal/media/5-help-icon.png){width=5% heigth=5%}
...
#### 5.7 Feedback pane ![](https://docs.microsoft.com/en-gb/learn/modules/tour-azure-portal/media/5-feedback-icon.png){width=5% heigth=5%}
...
6. Select **Done customizing**.

7. Select your name at the top right of the portal.
...
rmarkdown::render(input = "F05_cloud_manage.Rmd", output_format = "github_document", output_file = "README.md")
```
