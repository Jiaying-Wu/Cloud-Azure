...
##### 2.2.1 What's an Azure region? ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-azure-networking/media/2-azure-region.png){width=8% heigth=8%}
...
##### 2.2.2 What's a virtual network? ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-azure-networking/media/2-azure-vnet.png){width=8% heigth=8%}
...
##### 2.2.3 What's a network security group? ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-azure-networking/media/2-azure-nsg.png){width=8% heigth=8%}
...
#### 3.1 What are availability and high availability? ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-azure-networking/media/3-availability.png){width=8% heigth=8%}
...
#### 3.2 What is resiliency? ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-azure-networking/media/3-resiliency.png){width=8% heigth=8%}
...
#### 3.3 What is a load balancer? ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-azure-networking/media/3-lb.png){width=8% heigth=8%}
...
#### 3.6 What about DNS? ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-azure-networking/media/3-map-pin.png){width=8% heigth=8%}
...
#### 4.1 What is network latency? ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-azure-networking/media/4-latency.png){width=8% heigth=8%}
...
#### 4.2 Scale out to different regions ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-azure-networking/media/4-scale-out-regions.png){width=8% heigth=8%}
...
#### 4.3 Use Traffic Manager to route users to the closest endpoint ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-azure-networking/media/4-sign-post.png){width=8% heigth=8%}
...
#### 4.4 Compare Load Balancer to Traffic Manager ![](https://docs.microsoft.com/en-gb/learn/modules/intro-to-azure-networking/media/4-magnifying-glass.png){width=8% heigth=8%}
...
rmarkdown::render(input = "F08_cloud_networking.Rmd", output_format = "github_document", output_file = "README.md")
```
