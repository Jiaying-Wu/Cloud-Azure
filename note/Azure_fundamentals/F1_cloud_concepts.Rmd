...
##### 2.1.1 Compute power ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/2-compute-power.png){width=10% heigth=10%}
...
##### 2.1.2 Storage ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/2-storage.png){width=10% heigth=10%}
...
#### 3.1 It's cost-effective ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/3-cost-effective.png){width=10% heigth=10%}
...
#### 3.2 It's scalable ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/3-scalable.png){width=10% heigth=10%}
...
#### 3.3 It's elastic ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/3-elastic.png){width=10% heigth=10%}
...
#### 3.4 It's current ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/3-current.png){width=10% heigth=10%}
...
#### 3.5 It's reliable ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/3-reliable.png){width=10% heigth=10%}
...
#### 3.6 It's global ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/3-global.png){width=10% heigth=10%}
...
#### 3.7 It's secure ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/3-secure.png){width=10% heigth=10%}
...
### Topic 5: Economies of scale ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/3b-economiesofscale.png){width=10% heigth=10%}
...
##### 7.1.1 Public cloud ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/4-public-cloud.png){width=10% heigth=10%}
...
##### 7.1.2 Private cloud ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/4-private-cloud.png){width=10% heigth=10%}
...
##### 7.1.3 Hybrid cloud ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/4-hybrid-cloud.png){width=10% heigth=10%}
...
##### 8.1.1 Infrastructure as a service (IaaS) ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/5-iaas.png){width=10% heigth=10%}
...
##### 8.1.2 Platform as a service (PaaS) ![](https://docs.microsoft.com/en-gb/learn/modules/principles-cloud-computing/media/5-paas.png){width=10% heigth=10%}
